...
#pragma warning restore CS0067
        ...
        public static void Save(SceneReferenceCollection reference, scene scene)
        {
            ...
            if (scene.ASMScene(out var asmScene))
                SceneDataUtility.Set(asmScene, Key, reference);
        ...
        public static IEnumerable<ResolvedCrossReference> ResolveScene(scene scene)
        {
            ...
            if (Load(SceneManager.assets.scenes.Find(scene.path)) is SceneReferenceCollection references)
