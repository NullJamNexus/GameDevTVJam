    ...
    partial class SceneManagerWindow
    {
        ...
        class CollectionItem : ViewModel
        {
            ...
            public override void ApplyAppearanceSettings(VisualElement element)
            {
                ...
                element?.Q("label-reorder-collection")?.SetVisible(collection is SceneCollection);
            ...
            void SetupExpander()
            {
                ...
                void UpdateExpanded()
                {
                    var isExpanded = window.expandedCollections.Contains(collection.id);
            ...
            void SetupSceneHeaderDrop()
            {
                ...
                header.RegisterCallback<DragUpdatedEvent>(e =>
                {
                    ...
                    DragAndDrop.visualMode = scenes.Any() ? DragAndDropVisualMode.Link : DragAndDropVisualMode.Rejected;
            ...
            void SetupScenes()
            {
                ...
                void Reload()
                {
                    ...
                    if (collection is DynamicCollection d)
                        ...
                        views = collection.scenes?.Select((scene, i) => new SceneItem(collection, scene, i))?.ToArray() ?? Array.Empty<SceneItem>();
