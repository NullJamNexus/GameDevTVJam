...
namespace AdvancedSceneManager.Editor.UI
{
    ...
    public partial class SceneManagerWindow : EditorWindow
    {
        ...
        async void CreateGUI()
        {
            ...
            while (!SceneManager.settings.user)
                await Task.Delay(10);
        ...
        public void OnDisable() => sections?.Keys.ForEach(s => s.OnDisable());
        public void OnFocus()
        {
        ...
        public void OnLostFocus() => sections?.Keys.ForEach(s => s.OnLostFocus());
        ...
        void SetupDevMenu()
        {
            ...
            rootVisualElement.Q("button-menu").ContextMenu(e =>
            {
                ...
                e.menu.AppendAction("View tests...", _ => ShowFolder(TestsPath()));
            ...
            string TestsPath() => ASMPath() + "/Tests";
