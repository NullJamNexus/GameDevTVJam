...
namespace AdvancedSceneManager.Core
{
    ...
    public sealed class App
    {
        ...
        void CheckProfile()
        {
            ...
            {
                Debug.LogError("Could not find build profile!");
        ...
        void PrepareEnterPlayMode(out bool cancel)
        {
            ...
            {
                SceneManager.settings.user.sceneSetup = EditorSceneManager.GetSceneManagerSetup();
                SceneManager.settings.user.Save();
            }
        ...
        void EditorApplication_playModeStateChanged(PlayModeStateChange state)
        {
            if (state == PlayModeStateChange.EnteredEditMode)
            {
                ...
                var setup = SceneManager.settings.user.sceneSetup?.OfType<SceneSetup>()?.ToArray();
